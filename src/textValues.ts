...
export const numberNames: NumberNames = {
    ...
    [declensions.ACCUSATIVE]: ['ноль',
      {
        ...
        [genders.NEUTER]: 'одного',
        [genders.FEMALE]: 'одну',
      }, 'двух', 'три', 'четыре', 'пять', 'шесть', 'семь', 'восемь', 'девять'],
  ...
  tens: {
    ...
    [declensions.GENITIVE]: ['', '', 'двадцати', 'тридцати', 'сорока', 'пятьдесяти', 'шестьдесяти', 'семьдесяти', 'восемьдесяти', 'девяноста'],
    [declensions.DATIVE]: ['', '', 'двадцати', 'тридцати', 'сорока', 'пятьдесяти', 'шестьдесяти', 'семьдесяти', 'восемьдесяти', 'девяноста'],
    [declensions.ACCUSATIVE]: ['', '', 'двадцать', 'тридцать', 'сорок', 'пятьдесят', 'шестьдесят', 'семьдесят', 'восемьдесят', 'девяносто'],
    [declensions.INSTRUMENTAL]: ['', '', 'двадцатью', 'тридцатью', 'сорока', 'пятьдесятью', 'шестьдесятью', 'семьдесятью', 'восемьдесятью', 'девяноста'],
    [declensions.PREPOSITIONAL]: ['', '', 'двадцати', 'тридцати', 'сорока', 'пятьдесяти', 'шестьдесяти', 'семьдесяти', 'восемьдесяти', 'девяноста'],
  },
  hundreds: {
