...
const getCustomCurrency = (convertOptions: ConvertOptions): CustomCurrency => {
  ...
  // currencyNameCases[0]
  if (
    get(userCurrencyObject, ['currencyNameDeclensions', declensions.NOMINATIVE, 0]) === undefined
    && get(userCurrencyObject, ['currencyNameCases', 0]) !== undefined
  ) {
    set(editedCurrencyObject, ['currencyNameDeclensions', declensions.NOMINATIVE, 0], userCurrencyObject.currencyNameCases[0]);
  }
  // currencyNameCases[1]
  if (
    get(userCurrencyObject, ['currencyNameDeclensions', declensions.GENITIVE, 0]) === undefined
    && get(userCurrencyObject, ['currencyNameCases', 1]) !== undefined
  ) {
    set(editedCurrencyObject, ['currencyNameDeclensions', declensions.GENITIVE, 0], userCurrencyObject.currencyNameCases[1]);
  }
  // currencyNameCases[2]
  if (
    get(userCurrencyObject, ['currencyNameDeclensions', declensions.GENITIVE, 1]) === undefined
    && get(userCurrencyObject, ['currencyNameCases', 2]) !== undefined
  ) {
    set(editedCurrencyObject, ['currencyNameDeclensions', declensions.GENITIVE, 1], userCurrencyObject.currencyNameCases[2]);
  }
  ...
  if (
    get(userCurrencyObject, ['fractionalPartNameDeclensions', declensions.NOMINATIVE, 0]) === undefined
    && get(userCurrencyObject, ['fractionalPartNameCases', 0]) !== undefined
  ) {
    set(editedCurrencyObject, ['fractionalPartNameDeclensions', declensions.NOMINATIVE, 0], userCurrencyObject.fractionalPartNameCases[0]);
  }
  // fractionalPartNameCases[1]
  if (
    get(userCurrencyObject, ['fractionalPartNameDeclensions', declensions.GENITIVE, 0]) === undefined
    && get(userCurrencyObject, ['fractionalPartNameCases', 1]) !== undefined
  ) {
    set(editedCurrencyObject, ['fractionalPartNameDeclensions', declensions.GENITIVE, 0], userCurrencyObject.fractionalPartNameCases[1]);
  }
  // fractionalPartNameCases[2]
  if (
    get(userCurrencyObject, ['fractionalPartNameDeclensions', declensions.GENITIVE, 1]) === undefined
    && get(userCurrencyObject, ['fractionalPartNameCases', 2]) !== undefined
  ) {
    set(editedCurrencyObject, ['fractionalPartNameDeclensions', declensions.GENITIVE, 1], userCurrencyObject.fractionalPartNameCases[2]);
  }
