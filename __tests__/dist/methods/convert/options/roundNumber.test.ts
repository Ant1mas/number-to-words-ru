...
describe('roundNumber', () => {
  test('Проверка вариантов округления', () => {
    expect(convertNumberToWordsRu('0.995')).toBe('Один рубль 00 копеек')
    expect(convertNumberToWordsRu('.995')).toBe('Один рубль 00 копеек')
    expect(convertNumberToWordsRu('0.505')).toBe('Ноль рублей 51 копейка')
    expect(convertNumberToWordsRu('50.995')).toBe(
      'Пятьдесят один рубль 00 копеек',
    )
    expect(convertNumberToWordsRu('50.994')).toBe('Пятьдесят рублей 99 копеек')
    expect(convertNumberToWordsRu('999.995')).toBe(
      'Одна тысяча рублей 00 копеек',
    )
    expect(convertNumberToWordsRu('15999.995')).toBe(
  ...
  describe('slash delimiter', () => {
    test('common currency', () => {
      expect(
        convertNumberToWordsRu('1234/6789', {
          currency: 'rub',
          roundNumber: 50,
        }),
  ...
  describe('normal delimiter', () => {
    ...
    test('currency "number"', () => {
      ...
      expect(
        convertNumberToWordsRu('1234.0015', {
          currency: 'number',
          roundNumber: 4,
        }),
      ...
      expect(
        convertNumberToWordsRu('1.00089', {
          currency: 'number',
          roundNumber: 5,
        }),
