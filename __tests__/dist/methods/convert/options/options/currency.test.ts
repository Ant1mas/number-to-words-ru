  ...
  describe('string values', () => {
    test(`'rub'`, () => {
      expect(
        ...
        'Один миллион двести тридцать четыре тысячи пятьсот шестьдесят семь рублей 12 копеек',
      )
    })
    test(`'usd'`, () => {
      expect(
        ...
        'Один миллион двести тридцать четыре тысячи пятьсот шестьдесят семь долларов 12 центов',
      )
    })
    test(`'eur'`, () => {
      expect(
        ...
        'Один миллион двести тридцать четыре тысячи пятьсот шестьдесят семь евро 12 центов',
      )
    })
    test(`'number'`, () => {
      expect(
        ...
        'Один миллион двести тридцать четыре тысячи пятьсот шестьдесят семь целых 12345 стотысячных',
      )
      expect(
        convertNumberToWordsRu('1.8000', {
          currency: 'number',
        }),
      ...
      expect(
        ...
        'Один миллион двести тридцать четыре тысячи пятьсот шестьдесят семь целых двенадцать тысяч триста сорок пять стотысячных',
      )
      expect(
        convertNumberToWordsRu('1.8000', {
          currency: 'number',
      ...
      expect(
        convertNumberToWordsRu('1.00000', {
          currency: 'number',
          convertNumberToWords: {
            fractional: true,
          },
