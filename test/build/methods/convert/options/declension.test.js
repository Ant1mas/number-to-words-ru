...
describe('Проверка падежей', () => {
  describe('Родительный', () => {
    test('Обычные числа', () => {
      ...
      expect(convertNumberToWords('0', options))
        .toBe('Ноля рублей 00 копеек');
      expect(convertNumberToWords('1', options))
        .toBe('Одного рубля 00 копеек');
      expect(convertNumberToWords('2', options))
        .toBe('Двух рублей 00 копеек');
      expect(convertNumberToWords('3', options))
        .toBe('Трёх рублей 00 копеек');
      expect(convertNumberToWords('4', options))
        .toBe('Четырёх рублей 00 копеек');
      expect(convertNumberToWords('5', options))
        .toBe('Пяти рублей 00 копеек');
      expect(convertNumberToWords('10', options))
        .toBe('Десяти рублей 00 копеек');
      expect(convertNumberToWords('11', options))
        .toBe('Одиннадцати рублей 00 копеек');
      expect(convertNumberToWords('12', options))
        .toBe('Двенадцати рублей 00 копеек');
      expect(convertNumberToWords('15', options))
        .toBe('Пятнадцати рублей 00 копеек');
      expect(convertNumberToWords('20', options))
        .toBe('Двадцати рублей 00 копеек');
      expect(convertNumberToWords('21', options))
        .toBe('Двадцати одного рубля 00 копеек');
      expect(convertNumberToWords('30', options))
        .toBe('Тридцати рублей 00 копеек');
      expect(convertNumberToWords('32', options))
        .toBe('Тридцати двух рублей 00 копеек');
      expect(convertNumberToWords('40', options))
        .toBe('Сорока рублей 00 копеек');
      expect(convertNumberToWords('43', options))
        .toBe('Сорока трёх рублей 00 копеек');
      expect(convertNumberToWords('50', options))
        .toBe('Пятидесяти рублей 00 копеек');
      expect(convertNumberToWords('54', options))
        .toBe('Пятидесяти четырёх рублей 00 копеек');
      expect(convertNumberToWords('60', options))
        .toBe('Шестидесяти рублей 00 копеек');
      expect(convertNumberToWords('65', options))
        .toBe('Шестидесяти пяти рублей 00 копеек');
      expect(convertNumberToWords('90', options))
        .toBe('Девяноста рублей 00 копеек');
      expect(convertNumberToWords('99', options))
        .toBe('Девяноста девяти рублей 00 копеек');
      expect(convertNumberToWords('100', options))
        .toBe('Ста рублей 00 копеек');
      expect(convertNumberToWords('101', options))
        .toBe('Ста одного рубля 00 копеек');
      expect(convertNumberToWords('110', options))
        .toBe('Ста десяти рублей 00 копеек');
      expect(convertNumberToWords('200', options))
        .toBe('Двухсот рублей 00 копеек');
      expect(convertNumberToWords('201', options))
        .toBe('Двухсот одного рубля 00 копеек');
      expect(convertNumberToWords('210', options))
        .toBe('Двухсот десяти рублей 00 копеек');
      expect(convertNumberToWords('500', options))
        .toBe('Пятисот рублей 00 копеек');
      expect(convertNumberToWords('501', options))
        .toBe('Пятисот одного рубля 00 копеек');
      expect(convertNumberToWords('510', options))
        .toBe('Пятисот десяти рублей 00 копеек');
      expect(convertNumberToWords('1000', options))
        .toBe('Одной тысячи рублей 00 копеек');
      expect(convertNumberToWords('1001', options))
        .toBe('Одной тысячи одного рубля 00 копеек');
      expect(convertNumberToWords('1002', options))
        .toBe('Одной тысячи двух рублей 00 копеек');
      expect(convertNumberToWords('1005', options))
        .toBe('Одной тысячи пяти рублей 00 копеек');
      expect(convertNumberToWords('1100', options))
        .toBe('Одной тысячи ста рублей 00 копеек');
      expect(convertNumberToWords('1000000', options))
        .toBe('Одного миллиона рублей 00 копеек');
      expect(convertNumberToWords('987654321', options))
        .toBe('Девятисот восьмидесяти семи миллионов шестисот пятидесяти четырёх тысяч трёхсот двадцати одного рубля 00 копеек');
      expect(convertNumberToWords('1001121.01', { ...options, convertNumberToWords: { fractional: true } }))
        .toBe('Одного миллиона одной тысячи ста двадцати одного рубля одной копейки');
      expect(convertNumberToWords('2002122.02', { ...options, convertNumberToWords: { fractional: true } }))
        .toBe('Двух миллионов двух тысяч ста двадцати двух рублей двух копеек');
      expect(convertNumberToWords('5005125.05', { ...options, convertNumberToWords: { fractional: true } }))
    ...
    test('С валютой "number"', () => {
      ...
      expect(convertNumberToWords('1.0', options))
        .toBe('Одной целой ноля десятых');
      expect(convertNumberToWords('1.1', options))
        .toBe('Одной целой одной десятой');
      expect(convertNumberToWords('2.1', options))
        .toBe('Двух целых одной десятой');
      expect(convertNumberToWords('5.1', options))
        .toBe('Пяти целых одной десятой');
      expect(convertNumberToWords('11.1', options))
        .toBe('Одиннадцати целых одной десятой');
      expect(convertNumberToWords('101.1', options))
        .toBe('Ста одной целой одной десятой');
      expect(convertNumberToWords('102.1', options))
        .toBe('Ста двух целых одной десятой');
      expect(convertNumberToWords('1.2', options))
        .toBe('Одной целой двух десятых');
      expect(convertNumberToWords('1.5', options))
        .toBe('Одной целой пяти десятых');
      expect(convertNumberToWords('1.11', options))
        .toBe('Одной целой одиннадцати сотых');
      expect(convertNumberToWords('1.21', options))
        .toBe('Одной целой двадцати одной сотой');
      expect(convertNumberToWords('1.22', options))
        .toBe('Одной целой двадцати двух сотых');
      expect(convertNumberToWords('1.101', options))
        .toBe('Одной целой ста одной тысячной');
      expect(convertNumberToWords('1.102', options))
        .toBe('Одной целой ста двух тысячных');
      expect(convertNumberToWords('1.00001', options))
        .toBe('Одной целой одной стотысячной');
      expect(convertNumberToWords('1.00002', options))
    ...
    test('С разделителем "/"', () => {
      ...
      expect(convertNumberToWords('2/0', options))
        .toBe('Двух нулевых рубля');
      expect(convertNumberToWords('2/1', options))
        .toBe('Двух первых рубля');
      expect(convertNumberToWords('2/2', options))
        .toBe('Двух вторых рубля');
      expect(convertNumberToWords('2/5', options))
        .toBe('Двух пятых рубля');
      expect(convertNumberToWords('1/10', options))
        .toBe('Одной десятой рубля');
      expect(convertNumberToWords('1/11', options))
        .toBe('Одной одиннадцатой рубля');
      expect(convertNumberToWords('1/12', options))
        .toBe('Одной двенадцатой рубля');
      expect(convertNumberToWords('1/15', options))
        .toBe('Одной пятнадцатой рубля');
      expect(convertNumberToWords('1/20', options))
        .toBe('Одной двадцатой рубля');
      expect(convertNumberToWords('1/21', options))
        .toBe('Одной двадцать первой рубля');
      expect(convertNumberToWords('1/100', options))
        .toBe('Одной сотой рубля');
      expect(convertNumberToWords('1/101', options))
        .toBe('Одной сто первой рубля');
      expect(convertNumberToWords('1/102', options))
        .toBe('Одной сто второй рубля');
      expect(convertNumberToWords('1/110', options))
        .toBe('Одной сто десятой рубля');
      expect(convertNumberToWords('1/112', options))
        .toBe('Одной сто двенадцатой рубля');
      expect(convertNumberToWords('1/1000', options))
        .toBe('Одной тысячной рубля');
      expect(convertNumberToWords('1/1001', options))
        .toBe('Одной одна тысяча первой рубля');
      expect(convertNumberToWords('1/1002', options))
        .toBe('Одной одна тысяча второй рубля');
      expect(convertNumberToWords('1/1010', options))
        .toBe('Одной одна тысяча десятой рубля');
      expect(convertNumberToWords('1/1011', options))
        .toBe('Одной одна тысяча одиннадцатой рубля');
      expect(convertNumberToWords('1/1020', options))
        .toBe('Одной одна тысяча двадцатой рубля');
      expect(convertNumberToWords('1/1021', options))
        .toBe('Одной одна тысяча двадцать первой рубля');
      expect(convertNumberToWords('1/10000', options))
        .toBe('Одной десятитысячной рубля');
      expect(convertNumberToWords('1/11000', options))
        .toBe('Одной одиннадцатитысячной рубля');
      expect(convertNumberToWords('1/521000', options))
        .toBe('Одной пятисотдвадцатиоднотысячной рубля');
      expect(convertNumberToWords('1/1521000', options))
        .toBe('Одной один миллион пятисотдвадцатиоднотысячной рубля');
      expect(convertNumberToWords('1/1001002', options))
  ...
  describe('Падежи с настроенной валютой', () => {
    test('Объект падежей не указан', () => {
      ...
      expect(convertNumberToWords('4011121.01', {
        ...options,
      ...
      expect(convertNumberToWords('4011123.02', {
        ...options,
        declension: 'nominative',
        currency: {
          ...currency,
      ...
      expect(convertNumberToWords('4011122.02', {
        ...options,
        declension: 'genitive',
        currency: {
          ...currency,
